...
__author__ = 'Mr.Aahil'
__copyright = 'All rights reserved . Copyright  Mr.Aahil'
...
print("                PLEASE SELECT FB LITE")
#time.sleep(5)
os.system('clear')

logo = """

\x1b[1;91m            .d8b.  db   db d888888b db      
\x1b[1;92m           d8' `8b 88   88   `88'   88      
\x1b[1;97m           88ooo88 88ooo88    88    88      
\x1b[1;94m           88~~~88 88~~~88    88    88      
\x1b[1;95m           88   88 88   88   .88.   88booo. 
\x1b[1;96m           YP   YP YP   YP Y888888P Y88888P 

\x1b[1;97m------------------------------------------------------
GOOD WITH GOOD PEOPLE AN IF YOU BAD THEN I'M YOUR DAD
\x1b[1;97m------------------------------------------------------
           KOI TO PATA LO YAR MUJHY \x1b[1;92mAAHIL
\x1b[1;97m------------------------------------------------------
          Author       :   Rana Aahil Rajpoot
          Github       :   Github.com/R-R-AAHIL
          Fb page      :   Aahil Creations
\x1b[1;97m------------------------------------------------------
 \x1b[1;93m        use flight (airplane) mode before use
\x1b[1;97m------------------------------------------------------

"""
def reg():
    print logo
    print("             Concting To Aahil Servers")
    print("")
...
def log_menu():
    ...
    try:
        ...
        os.system('clear')
        print logo
        print("             \x1b[1;92m  [ FREE MODE ACTIVATED ]")
        print("")
        print("\x1b[1;97m")
        print 47 * '-'
        print("[:] select 2")
        print("")
        print '\x1b[1;97m[1] Login with Email Pass'
...
def log_menu_s():
    s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def log_fb():
    ...
    print 47 * '-'
    lid = raw_input('\x1b[1;97m Id/mail/no: ')
    pwds = raw_input(' \x1b[1;97mPassword: ')
...
def log_token():
    os.system('clear')
    print logo
    tok = raw_input(' \x1b[1;97mPaste token here: \x1b[1;97m')
...
def menu():
    ...
    print("")
    print '\x1b[1;97m[1] Crack with Auto password 10'
    print '\x1b[1;97m[2] Crack with Number password 6'
    print '\x1b[1;97m[3] Crack with Name + Number password 8'
    print '\x1b[1;97m[4] Make File'
    print '\x1b[1;97m[5] Logout'
    print '\x1b[1;97m[6] Delete trash files'
    menu_s()


def menu_s():
    ms = raw_input('\x1b[1 ;\xe2\x95\xb0\xe2\x94\x80\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def rtrash():
    ...
    print logo
    print("")
    print("           REST DATA MAKING COMMANDS COOL")
    print("")
    print("                  DELETEING TRASH...")
    print("")
    time.sleep(2)
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Aahil\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
        print 47 * '-'
        ...
        try:
            idlist = raw_input(' \x1b[1;97m[+] File Name: \x1b[1;97m ')
    ...
    if a_s == '0':
        ...
        a_s()
    print ' \x1b[1;97mTotal ids: \x1b[1;97m ' + str(len(id))
    time.sleep(0.5)
    print ' \x1b[1;97mCrack Running\x1b[1;97m '
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;97mDevelop by Rana Aahil\x1b[1;97m'
    print 47 * '-'
...
def c_s():
    ...
    if a_s == '1':
        ...
        print 47 * '-'
        pass1 = raw_input(' \x1b[1;97m[1]Password: ')
        pass2 = raw_input(' \x1b[1;97m[2]Password: ')
        pass3 = raw_input(' \x1b[1;97m[3]Password: ')
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;97mAahil King Of Fcebook\x1b[1;97m'
    print 47 * '-'
